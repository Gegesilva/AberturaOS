...
function gravaOS($conn, $estado, $local, $email, $contpb, $serie, $whatsapp, $solicitante, $defeito, $periodo)
{
    ...
    // Prepara o SQL de inserção com parâmetros
    $sql = "
    INSERT INTO TB02115(
        TB02115_CODIGO, TB02115_DTCAD, TB02115_ESTADO, TB02115_LOCAL, TB02115_EMAIL, TB02115_CONTPB,
        TB02115_NUMSERIE, TB02115_CELULAR, TB02115_SOLICITANTE, TB02115_OBS, TB02115_STATUS, TB02115_NOME,
        TB02115_OPCAD, TB02115_CONTRATO, TB02115_CODEMP, TB02115_CODCLI, TB02115_TIPOINTERV, TB02115_PRODUTO,
        TB02115_CODTEC, TB02115_ATENDENTE, TB02115_PREVENTIVA, TB02115_DATA, TB02115_SITUACAO,
        TB02115_CEP, TB02115_END, TB02115_CIDADE, TB02115_BAIRRO, TB02115_NUM, TB02115_COMP
    )
    SELECT TOP 1 ?, GETDATE(), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'APP ABERTURA_OS',
           TB02112_CODIGO, TB02111_CODEMP, TB02111_CODCLI, 'I', TB02112_PRODUTO,
           '0000', 'PortalQR', 'N', GETDATE(), 'A',
           TB02112_CEP, TB02112_END, TB02112_CIDADE, TB02112_BAIRRO, TB02112_NUM, CAST(TB02112_COMP AS VARCHAR(20))
    FROM TB02112
